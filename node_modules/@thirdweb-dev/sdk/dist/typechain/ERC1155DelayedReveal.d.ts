...
export interface ERC1155DelayedRevealInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "balanceOfBatch" | "batchMintTo" | "burn" | "burnBatch" | "contractURI" | "encryptDecrypt" | "encryptedData" | "getBaseURICount" | "getBatchIdAtIndex" | "getDefaultRoyaltyInfo" | "getRevealURI" | "getRoyaltyInfoForToken" | "isApprovedForAll" | "isEncryptedBatch" | "lazyMint" | "mintTo" | "multicall" | "name" | "nextTokenIdToMint" | "owner" | "reveal" | "royaltyInfo" | "safeBatchTransferFrom" | "safeTransferFrom" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "totalSupply" | "uri"): FunctionFragment;
...
export interface ERC1155DelayedReveal extends BaseContract {
    ...
    functions: {
        ...
        batchMintTo(_to: string, _tokenIds: BigNumberish[], _amounts: BigNumberish[], arg3: string, overrides?: Overrides & {
        ...
        mintTo(_to: string, _tokenId: BigNumberish, arg2: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        balanceOf(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        balanceOfBatch(accounts: string[], ids: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber[]>;
        batchMintTo(_to: string, _tokenIds: BigNumberish[], _amounts: BigNumberish[], arg3: string, overrides?: CallOverrides): Promise<void>;
        ...
        mintTo(_to: string, _tokenId: BigNumberish, arg2: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
