import { ClaimNFTParams, ClaimNFTReturnType, DropContract, NFTContract, RequiredParam } from "@thirdweb-dev/react/dist/types";
 ...
 * @beta
 */
export declare function useClaimedNFTs(contract: RequiredParam<DropContract>, queryParams?: QueryAllParams): import("@tanstack/react-query").UseQueryResult<import("@thirdweb-dev/react/dist/types").NFT<DropContract>[], unknown>;
/**
 *
