import type { DefaultedInfiniteQueryObserverOptions, FetchNextPageOptions, FetchPreviousPageOptions, InfiniteData, InfiniteQueryObserverOptions, InfiniteQueryObserverResult, QueryKey } from '@tanstack/query-core/build/types/packages/query-core/src/types';
import type { QueryClient } from '@tanstack/query-core/build/types/packages/query-core/src/queryClient';
import { NotifyOptions, ObserverFetchOptions, QueryObserver } from '@tanstack/query-core/build/types/packages/query-core/src/queryObserver';
import { Query } from '@tanstack/query-core/build/types/packages/query-core/src/query';
