import type { Mutation } from '@tanstack/query-core/build/types/packages/query-core/src/mutation';
import type { Query } from '@tanstack/query-core/build/types/packages/query-core/src/query';
import type { FetchStatus, MutationFunction, MutationKey, MutationOptions, QueryFunction, QueryKey, QueryOptions } from '@tanstack/query-core/build/types/packages/query-core/src/types';
