import type { MutationOptions, MutationStatus, MutationMeta } from '@tanstack/query-core/build/types/packages/query-core/src/types';
import type { MutationCache } from '@tanstack/query-core/build/types/packages/query-core/src/mutationCache';
import type { MutationObserver } from '@tanstack/query-core/build/types/packages/query-core/src/mutationObserver';
