import { Action } from '@tanstack/query-core/build/types/packages/query-core/src/mutation';
...
import type { MutateOptions, MutationObserverResult, MutationObserverOptions } from '@tanstack/query-core/build/types/packages/query-core/src/types';
